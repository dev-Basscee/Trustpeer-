...
export { idlFactory } from './Contract_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CONTRACT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Contract_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Contract_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Contract_backend.did.js")._SERVICE>}
 */
export const Contract_backend = createActor(canisterId);
